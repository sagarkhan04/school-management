...
<head>
    ...
    <!-- ==============================
  * Template Name: School Management - v2.3.1
...
<body>
    ...
    <header id="header" class="header fixed-top d-flex align-items-center">
        ...
        <nav class="header-nav ms-auto">
            <ul class="d-flex align-items-center">
                ...
                <a class="nav-link nav-icon" target="_blank" href="{{route('frontend.index')}}">
                        <i class="btn bg-info">View</i>
                    </a><!-- View Notification Icon -->
                ...
                <li class="nav-item dropdown pe-3">
                    ...
                    <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
                        ...
                        <span class="d-none d-md-block dropdown-toggle ps-2">Md. Sagar</span>
    ...
    <footer id="footer" class="footer">
        <div class="copyright">
            &copy; Copyright <strong><span>School Management System</span></strong>. All Rights Reserved
        </div>
    </footer><!-- End Footer -->
